...
export default function MapPage() {
  ...
  useEffect(() => {
    ...
    const options = {
      center: new window.kakao.maps.LatLng(37.4979, 127.0276), // 기본 위치 (부산 해운대)
      level: 8,
    };
        ...
        <div className="p-4">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
            <p className="text-red-600 font-semibold">
              환경 변수 NEXT_PUBLIC_KAKAO_MAP_API_KEY가 설정되지 않았습니다.
            </p>
            <p className="text-sm text-red-500 mt-2">
              .env 파일에 Kakao Maps API 키를 추가해주세요.
            </p>
          </div>
        </div>
      </MainLayout>
    ...
    <>
      <Script
        ...
        onLoad={() => {
          ...
          if (!kakao?.maps?.load) {
            ...
            setMapError(`Kakao Maps SDK를 불러오지 못했습니다. 개발자 콘솔에서 등록된 도메인(${domain})을 확인해주세요.`);
            return;
          }
      ...
      <MainLayout>
        <div className="p-4">
          ...
          <div
            id="map"
            className="w-full h-[calc(100vh-200px)] rounded-lg border-2 border-gray-200 overflow-hidden"
          />
